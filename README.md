...
Отправьте скрин магазина боту как фото. Бот выполняет форензик-сравнение по нескольким сигналам (перцептивные хэши, цветовой профиль, форма/плотность тела и контурная детализация), сканирует кадр по окнам и пытается найти до 3 разных эмодзи на одном изображении.
