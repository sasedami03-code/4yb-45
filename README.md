...
Отправьте скрин магазина боту как фото. Бот сравнит изображение с ассетами по нескольким сигналам (перцептивные хэши, цветовой профиль, форма/плотность тела и контурная детализация) и пришлёт топ-3 совпадения с текущим рейтингом из базы.
